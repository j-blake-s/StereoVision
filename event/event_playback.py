...
from metavision_core.event_io import EventsIterator, LiveReplayEventsIterator, is_live_camera, RawReader
...
def main():
    ...
    # Iterate over events
    mv_iterator = EventsIterator(input_path=args.filename, delta_t=1000)
    ...
    with MTWindow(title="Metavision Events Viewer", width=width, height=height,
        ...
        def on_cd_frame_cb(ts, cd_frame): window.show_async(cd_frame)
